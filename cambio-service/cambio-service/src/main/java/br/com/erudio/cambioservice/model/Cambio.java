...
public class Cambio implements Serializable {
    ...
    @Transient // pra dizer pro Hibernate e JPA que esse cara não vai ser persistido no BD
    ...
    public Cambio(Long id, String from, String to, BigDecimal convertionFactor, BigDecimal convertedValue,  String enviroment) {
        this.id = id;
        this.from = from;
        this.to = to;
